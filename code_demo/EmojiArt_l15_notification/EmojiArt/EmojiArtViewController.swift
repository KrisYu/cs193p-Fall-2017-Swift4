...
//  @IBAction func save(_ sender: UIBarButtonItem? = nil) {
    ...
    // This is a default observer UIDocumentStateChanged
    ...
    // decide show the warning later or not
    ...
    private func presentBadURLWarning(for url: URL?){
        if !suppressBadURLWarnings {
            ...
            // do not use title yes or no, but use more infomative way
