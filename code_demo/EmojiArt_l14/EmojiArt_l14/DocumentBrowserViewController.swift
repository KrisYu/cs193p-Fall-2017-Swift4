...
class DocumentBrowserViewController: UIDocumentBrowserViewController, UIDocumentBrowserViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if UIDevice.current.userInterfaceIdiom == .pad {
            ...
            if template != nil {
                // return boolean whether the file created or exists
    ...
    func presentDocument(at documentURL: URL) {
        ...
        // get the navigation controller to present - call it DocumentMVC
        let documentVC = storyBoard.instantiateViewController(withIdentifier: "DocumentMVC")
        if let emojiArtViewController = documentVC.contents as? EmojiArtViewController {
            // this fileURL is the documentURL, the parameter
